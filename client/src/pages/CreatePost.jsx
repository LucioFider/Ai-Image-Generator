...
const CreatePost = () => {
  ...
  const [generatingImg, getGeneratingImg] = useState(false);
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#22233] text-[32px]">Create</h1>
      ...
      <form action="#" className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once you have created the image you wanted, you can share it with
